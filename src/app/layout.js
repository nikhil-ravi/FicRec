...
export const metadata = {
  title: "RecFic",
  description:
    "RecFic is a fanfiction recommendation engine that uses a neural network to embed search queries and fanfiction summaries into a common vector space. Given a search query, RecFic will return a list of fanfictions that are semantically similar to the query.",
  author: "Nikhil Ravi",
  keywords:
